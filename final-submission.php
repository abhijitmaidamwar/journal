		...
		<div class="container-main">
			<div class="row">
                ...
                <h4>Submit Final Manuscript</h4>
                 <div id="hideForm">
                <?php if(!empty($checkforscript) && $checkforscript[0]['is_done']) {?>
						...
						if($checkforscript[0]['pay_mode'] == "cash_or_onlinetransfer"){
							...
							if($checkforscript[0]['pay_mode'] == 'payment_gateway'){
					...
					if(!empty($fetchscript[0]['pagekey'])) { ?>
                     ...
                     <input type="hidden" name="paperId" id="paperId" value="<?php echo $fetchscript[0]['paperId']; ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                            	<a class="btn btn-info btn-xs pull-right" id="addmore" style="margin-top: 10px;" href="javascript:void(0);">Add More Co-Author <i class="fa fa-plus"></i></a>
                        	</div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">
                        ...
                        <div class="form-group">
                        	...
                        	<div class="col-sm-6">
                        		<input type="radio" checked="checked" name="pay_mode" class="pay_mode" value="cash_or_onlinetransfer" /> Cash / Online Transfer<br /><small>(Please upload your payment proof)</small> <br />
                        ...
                        <div class="form-group pull-right">
                            <div class="col-sm-12 col-md-12">
                                <input type="submit" name="submit" id="submit" value="Proceed" class="btn btn-info pull-right" />
                            </div>
                          </div>
                    </form>
					<script>
						...
						function getAmount(){
							...
							$.ajax({
								...
								success: function(res){
									// alert(res);
									$("#totalamt").fadeIn().html(res.currency_symbol+""+res.final_amt);
								}
							});
						}
					</script>                    
