...
<html lang="en">
		...
		<div class="container-main">
			<div class="row">
				...
				<div class="col-xs-12 col-md-7">
					...
					<p>
						IJIES /Innovative scientific publication (ISP)  is committed to maintaining your confidence and trust with respect to the privacy of the personal information we collect from you. Please read this privacy policy carefully to understand our practices about how we collect, use and share your personal information.
					</p>

					<h5>About our Privacy Policy</h5>

					<p>
						This privacy policy describes how the personal information that is collected when you visit the IJIES website, application or product that posts a link to this privacy policy ("Service") will be used by the IJIES/ Innovative scientific publication(ISP) company that owns the Service ("ISP," "we," "us" or "our"). This policy may be supplemented by additional privacy terms or notices set forth on certain areas of the Service.
					</p>
					...
					<ul>
						<li>
							Provide the Service to you, such as allow access to or delivery of our products or services, process or fulfil an order or transaction, or administer surveys or promotional programs;
						</li>
						<li>
						...
						<li>
							Identify and analyze usage trends, including for the purposes of research, audits, reporting and paying royalties and license fees to third-party content providers; Notify you about changes or updates to the Service and our products and services; and
						</li>
						<li>
					...
					We may on occasion also match or combine the personal information that you provide with information that we obtain from other sources or that is already in our records, whether collected online or offline or by predecessor or affiliated group companies, for the purposes described above.</li>
					...
					<p>
						if ISP, the Service or a related asset or line of business is acquired by, transferred to or merged with another company.
					</p>
					...
					<h5>Your Choices and Communications Preferences</h5>
					<p>
					...
					<h5>Access to and Accuracy of Your Information</h5>

					<p>
						The Service may allow registered users to access their account information and make corrections or updates upon log in at any time. The accuracy of such information is solely the responsibility of the user. You may also request access to other personal information about you that may be held in the Service. If you request to deactivate your account or delete your personal information, we will endeavour to fulfil your request but some personal information may persist in backup copies for a certain period of time and may be retained as necessary for legitimate business purposes or to comply with our legal obligations.
					</p>

					<h5>Data Security</h5>

					<p>
						IJIES (ISP) takes precautions to safeguard your personal information against loss, theft and misuse and unauthorized access, disclosure, alteration and destruction through the use of appropriate administrative, physical and technical security measures.
					</p>

					<h5>
					Cross-Border Transfer of Your Information</h5>
	...
	<li>
 When the authors will submit the manuscripts, he or she will accept the Terms & Conditions of this publication.   </li>                                                 
	<li>It is mandatory that as per policy once authors will submit the manuscript it should not be under consideration  at any other publication until review process completed .</li>    
	<li> If author will cancel the publication after doing the payment but before of publication of final manuscript , 20% charges will be deducted for review process charges of the publication.    </li>                             
	<li> After final publication of manuscript on website ,authors should not cancel the manuscript and will not get any refund for that.   </li>                      
	<li> After final publication of manuscript, no changes in manuscripts in terms of authors, affiliations and manuscript content will be consider.</li>    </ul>
